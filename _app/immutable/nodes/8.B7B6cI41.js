import{s as Et,n as ct}from"../chunks/scheduler.BfJEPAwo.js";import{S as Ht,i as kt,e as n,a as dt,s as a,c as o,b as G,d as pt,f as e,g as r,n as $,h as l,j as y,k as Lt,o as Ft,m as u,p as Rt,q as At,t as Mt,r as Ot,u as Dt}from"../chunks/index.ECjNkreQ.js";const Nt=!0,Yt=Object.freeze(Object.defineProperty({__proto__:null,prerender:Nt},Symbol.toStringTag,{value:"Module"}));function Ut(f){let s,v,p,d,C,T,_,b,x,m,q;return{c(){s=n("details"),v=n("summary"),p=n("b"),d=dt(f[1]),C=a(),T=n("br"),_=a(),b=n("pre"),x=n("code"),m=dt(f[0]),q=dt(`
