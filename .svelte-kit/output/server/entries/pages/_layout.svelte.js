...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div id="page-container" class="svelte-1qf80bv">${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main id="content-wrap" class="svelte-1qf80bv">${slots.default ? slots.default({}) : ``}</main> <footer id="footer" class="svelte-1qf80bv" data-svelte-h="svelte-1qehjw3"><div><p>©2023 Akhil, Powered by SvelteKit. More about this site</p></div></footer> </div>`;
});
export {
  Layout as default
};
